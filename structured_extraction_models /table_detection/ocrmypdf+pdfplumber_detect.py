...
output_dir = "../../tst/table_detection_analysis/pdfplumber/ocr_output"
tables_dir = "../../tst/table_detection_analysis/pdfplumber/tables"
...
for root, dirs, files in os.walk(input_dir):
    for filename in files:
        if filename.lower().endswith(".pdf"):
            ...
            ocr_pdf_path = os.path.join(output_dir, f"ocr_{filename}")

            # 1. Run OCR on every PDF with --force-ocr
            subprocess.run([
                "ocrmypdf",
                "--force-ocr",
                pdf_path,
