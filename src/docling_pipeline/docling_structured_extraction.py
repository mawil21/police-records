...
def table_to_json(table):
    return {
        ...
        "cells": [[table_cell_to_dict(cell) for cell in row] for row in table.data.grid],
...
def extract_key_value_pairs(pdf):
    doc_converter = DocumentConverter()
    conv_res = doc_converter.convert(pdf)
...
def page_segment_retrieval(doc, structured_data, extraction_dir_name):
    images = {}
...
#     output_pdf_dir = "../tst/document_layouts" # Directory to save the extraction results of PDF documents
