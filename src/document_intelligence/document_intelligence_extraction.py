...
def process_pdf(pdf_file, input_dir, output_dir, azure_client):
...
def process_pdf_directory(input_dir, output_dir, azure_client):
    for root, _, files in os.walk(input_dir):
        ...
        for file in files:
            if file.endswith('.pdf'):
                ...
                process_pdf(full_pdf_path, input_dir, output_dir, azure_client)
...
if __name__ == "__main__":
    ...
    output_pdf_dir = "../tst/document_intelligence_kv_pairs" # Directory to save the extraction results of PDF documents
    ...
    process_pdf_directory(input_pdf_dir, output_pdf_dir, azure_client)
